...
namespace UnityEngine.U2D.Animation
{
    internal class TransformAccessJob
    {
        ...
        NativeParallelHashMap<int, TransformData> m_TransformData;
        ...
        public TransformAccessJob()
        {
            ...
            m_TransformData  = new NativeParallelHashMap<int, TransformData>(1, Allocator.Persistent);
        ...
        public NativeParallelHashMap<int, TransformData> transformData
        {
