...
namespace UnityEngine.U2D.Animation
{
    ...
    internal struct UpdateBoundJob : IJobParallelFor
    {
        ...
        [ReadOnly]
        public NativeParallelHashMap<int, TransformAccessJob.TransformData> rootTransformIndex;
        [ReadOnly]
        public NativeParallelHashMap<int, TransformAccessJob.TransformData> boneTransformIndex;
        [ReadOnly]
